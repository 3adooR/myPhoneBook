...
<form id="form" action="?go=list" method="post" enctype="multipart/form-data">
    <div class="office-form">
        ...
        <div class="gline">
            ...
            <div>
                ...
                <input type="file" id="file" onchange="uploadFile('0')"/>
                <div class="preview">
        ...
        <div class="gline actions">
            <div><input class="btn" type="button" name="office-list-add" value="Добавить"/></div>
            <div>
